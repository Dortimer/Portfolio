...
namespace Portfolio.Data.Migrations
{
    ...
    [Migration("20260825231735_UpdatePortfolioModel")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Portfolio.Core.Entities.Position", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Portfolio.Core.Entities.Qualification", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Portfolio.Core.Entities.Company", b =>
                {
                    b.HasOne("Portfolio.Core.Entities.Contact", "CompanyContact")
                        .WithMany()
            ...
            modelBuilder.Entity("Portfolio.Core.Entities.Education", b =>
                {
                    b.HasOne("Portfolio.Core.Entities.Contact", "SchoolContact")
                        .WithMany()
            ...
            modelBuilder.Entity("Portfolio.Core.Entities.Experience", b =>
                {
                    b.HasOne("Portfolio.Core.Entities.Position", null)
            ...
            modelBuilder.Entity("Portfolio.Core.Entities.Position", b =>
                {
                    b.HasOne("Portfolio.Core.Entities.Company", "Company")
                        .WithMany()
